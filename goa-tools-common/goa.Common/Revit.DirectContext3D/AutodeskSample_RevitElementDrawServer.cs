...
namespace MAT_QUAN
{
    class RevitElementDrawServer : IDirectContext3DServer
    {
        public static bool UpdateAll = false;
        public RevitElementDrawServer(UIDocument uiDoc, Element elem, XYZ offset)
        {
            m_guid = Guid.NewGuid();
