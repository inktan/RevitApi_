...
{
    internal class StoreySteelBeamDoubleLine : RequestMethod
    {
        internal StoreySteelBeamDoubleLine(UIApplication _uiApp) : base(_uiApp)
        {
        ...
        internal override void Execute()
        {
            ...
            // 梁-钢
            eleInfo = new SteelBeamDoubleLine();
            ...
            //this.sw.Stop();
            //$"{this.sw.ElapsedMilliseconds} + 毫秒".TaskDialogErrorMessage();
        }
    }
}
