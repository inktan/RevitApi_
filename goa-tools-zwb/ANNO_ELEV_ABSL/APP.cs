...
namespace GOA.ANNO_ELEV_ABSL
{
    public class APP : IExternalApplication
    {
        ...
        public void StartUpSetup(UIControlledApplication _uiCtrlApp)
        {
            ...
            string panelName = "快捷标注";
            string buttonName = "绝对标高";
        ...
        {
            PushButtonData b1 =
                new PushButtonData("GOA.ANNO_ELEV_ABSL",
                                    _buttonName,
                                    addinPath(),
                                    "GOA.ANNO_ELEV_ABSL.CMD");

            var iconBitmap = global::GOA.ANNO_ELEV_ABSL.Properties.Resources.ANNO_ELEV_ABSL_32;
