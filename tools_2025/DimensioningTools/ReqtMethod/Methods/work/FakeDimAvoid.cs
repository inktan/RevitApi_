...
{
    internal class FakeDimAvoid : RequestMethod
    {
        internal FakeDimAvoid(UIApplication _uiApp) : base(_uiApp)
        {
        }
        internal override void Execute()
        {
            ...
            Parameter viewScale = this.view.get_Parameter(BuiltInParameter.VIEW_SCALE);
