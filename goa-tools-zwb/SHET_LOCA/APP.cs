...
namespace GOA.SHET_LOCA
{
    public class APP : IExternalApplication
    {
        ...
        public void StartUpSetup(UIControlledApplication _uiCtrlApp)
        {
            ...
            string panelName = "布图工具";
            string buttonName = "区位图";
        ...
        {
            PushButtonData b1 =
                new PushButtonData("GOA.SHET_LOCA",
                                    _buttonName,
                                    addinPath(),
                                    "GOA.SHET_LOCA.CMD");

            var iconBitmap = global::GOA.SHET_LOCA.Properties.Resources.SHET_LOCA_32;
