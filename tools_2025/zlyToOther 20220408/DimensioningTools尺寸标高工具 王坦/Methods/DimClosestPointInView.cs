...
namespace DimensioningTools
{
    internal static partial class Methods
    {
        /// <summary>
        /// 标注最近点
        /// select two elements, create dimension between the two closest points.
        /// The two elements need to contain solid geometry.
        /// </summary>
        internal static void DimClosestPointInView()
        {
            ...
            //select two elems
            Form_cursorPrompt.Start("选择第一个图元", APP.MainWindow);
            var pick1 = sel.PickObject(ObjectType.Element);
            Form_cursorPrompt.Start("选择第二个图元", APP.MainWindow);
            var pick2 = sel.PickObject(ObjectType.Element);
        ...
        private static List<Edge> getStraightEdgesOfDir(Solid _solid, XYZ _dir)
        {
