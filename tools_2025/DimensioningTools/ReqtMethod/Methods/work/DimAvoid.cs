...
{
    internal class DimAvoid : RequestMethod
    {
        internal DimAvoid(UIApplication _uiApp) : base(_uiApp)
        {
        }
        /// <summary>
        /// 真尺寸避让
        ...
        internal override void Execute()
        {
            ...
            Parameter viewScale = GetViewScale(this.view);
            ...
            using (TransactionGroup tg = new TransactionGroup(document, "尺寸避让"))
            {
                ...
                do
                {
                    ...
                    try
                    {
                        dimension = SelectDimension(this.uiDoc);
                    }
