        ...
        public void Execute(UIApplication uiapp)
        {
            ...
            try
            {
                ...
                switch (Request.Take())//Request.Take()数据提取 只能有一次
                {
                    ...
                    case RequestId.IncludingLinkedModels:
                        {
                            TransactionGroup transactionGroup = new TransactionGroup(uiapp.ActiveUIDocument.Document);
                            transactionGroup.Start("框选检查-含链接模型");

                            requestMethod = new IncludingLinkedModels(uiapp);
                            requestMethod.Execute();
                            transactionGroup.Assimilate();
                            GC.Collect();
                            break;
                        }
                    case RequestId.ExcludingLinkedModels:
                        {
                            TransactionGroup transactionGroup = new TransactionGroup(uiapp.ActiveUIDocument.Document);
                            transactionGroup.Start("框选检查-不含链接模型");

                            requestMethod = new ExcludingLinkedModels(uiapp);
                            requestMethod.Execute();
                            transactionGroup.Assimilate();
                            GC.Collect();
                            break;
                        }
                    case RequestId.IncludingLinkedModelsAll:
                        {
                            TransactionGroup transactionGroup = new TransactionGroup(uiapp.ActiveUIDocument.Document);
                            transactionGroup.Start("全局检查-含链接模型");

                            requestMethod = new IncludingLinkedModelsAll(uiapp);
                            requestMethod.Execute();
                            transactionGroup.Assimilate();
                            GC.Collect();
                            break;
                        }
                    case RequestId.ExcludingLinkedModelsAll:
                        {
                            TransactionGroup transactionGroup = new TransactionGroup(uiapp.ActiveUIDocument.Document);
                            transactionGroup.Start("全局检查-不含链接模型");

                            requestMethod = new ExcludingLinkedModelsAll(uiapp);
                            requestMethod.Execute();
                            transactionGroup.Assimilate();
                            GC.Collect();
                            break;
                    ...
                    case RequestId.FrameSel_LinkedStruModels:
                        {
                            TransactionGroup transactionGroup = new TransactionGroup(uiapp.ActiveUIDocument.Document);
                            transactionGroup.Start("款选检查-针对结构");

                            requestMethod = new FrameSel_LinkedStruModels(uiapp);
                            requestMethod.Execute();
                            transactionGroup.Assimilate();
                            GC.Collect();
                            break;
                        }
                    case RequestId.AllSel_LinkedStruModels:
                        {
                            TransactionGroup transactionGroup = new TransactionGroup(uiapp.ActiveUIDocument.Document);
                            transactionGroup.Start("全局检查-针对结构");

                            requestMethod = new AllSel_LinkedStruModels(uiapp);
                            requestMethod.Execute();
                            transactionGroup.Assimilate();
                            GC.Collect();
                            break;
