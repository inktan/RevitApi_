...
namespace g3
{
	public class Polygon2d : IDuplicatable<Polygon2d>
    {
        ...
        /// <summary>
        /// 如果 点在多边形内 或者 落在边界上 均返回true，使用快速绕线数计算
        ...
        /// <summary>
        /// 检查线段上的所有点是否在Polygon2d定义的区域内（需要确认边界关系）
        ...
        /// <summary>
        /// 检查线段上的任何点是否在Polygon2d定义的区域内（需要确认边界关系）
        ...
        /// <summary>
        /// 获取多边形，指定边上的，指定点位置的向量？？？
        /// </summary>
        /// <param name="iSegment"></param>
        /// <param name="fSegT"></param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="p"></param>
        /// <param name="iNearSeg"></param>
        /// <param name="fNearSegT"></param>
        /// <returns></returns>
        ...
        /// 沿顶点法线方向按距离偏移每个点（即切线perp）逆时针多边形偏移“向外”，顺时针“向内”
        /// </summary>
        ...
        /// CCW polygon offsets "outwards", CW "inwards".
        /// 通过偏移和相交边，按固定距离偏移多边形。逆时针多边形偏移“向外”，顺时针“向内”。
        /// </summary>
        ...
        /// <summary>
        /// Return minimal bounding box of vertices, computed to epsilon tolerance 返回顶点的最小边界框，计算为epsilon容差
        /// </summary>
    ...
    /// <summary>
    /// Wrapper for a Polygon2d that provides minimal IParametricCurve2D interface   提供最小IParametricCurve2D接口的Polygon2d包装器
    /// </summary>
