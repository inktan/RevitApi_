...
namespace GOA.COMP_MANG
{
    public class APP : IExternalApplication
    {
        ...
        public void StartUpSetup(UIControlledApplication _uiCtrlApp)
        {
            ...
            string panelName = "构件管理";
            string buttonName = "组件管理";
        ...
        {
            PushButtonData b1 =
                new PushButtonData("GOA.COMP_MANG",
                                    _buttonName,
                                    addinPath(),
                                    "GOA.COMP_MANG.CMD");

            var iconBitmap = global::GOA.COMP_MANG.Properties.Resources.COMP_MANG_32;
