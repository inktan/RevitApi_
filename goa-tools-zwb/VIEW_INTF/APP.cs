...
namespace GOA.VIEW_INTF
{
    public class APP : IExternalApplication
    {
        ...
        public void StartUpSetup(UIControlledApplication _uiCtrlApp)
        {
            ...
            string panelName = "视图工具";
            string buttonName = "提资视图";
        ...
        {
            PushButtonData b1 =
                new PushButtonData("GOA.VIEW_INTF",
                                    _buttonName,
                                    addinPath(),
                                    "GOA.VIEW_INTF.CMD");

            var iconBitmap = global::GOA.VIEW_INTF.Properties.Resources.VIEW_INTF_32;
