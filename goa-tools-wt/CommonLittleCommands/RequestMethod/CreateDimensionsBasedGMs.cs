...
{
    class CreateDimensionsBasedGMs : RequestMethod
    {
        public CreateDimensionsBasedGMs(UIApplication uiapp) : base(uiapp)
        { }
        ...
        internal override void Execute()
        {
            ...
            FamilyInstance familyInstance01 = doc.GetElement(sel.PickObject(ObjectType.Element)) as FamilyInstance;
            FamilyInstance familyInstance02 = doc.GetElement(sel.PickObject(ObjectType.Element)) as FamilyInstance;
            FamilyInstance familyInstance03 = doc.GetElement(sel.PickObject(ObjectType.Element)) as FamilyInstance;
            FamilyInstance familyInstance04 = doc.GetElement(sel.PickObject(ObjectType.Element)) as FamilyInstance;
            FamilyInstance familyInstance05 = doc.GetElement(sel.PickObject(ObjectType.Element)) as FamilyInstance;

            familyInstances.Add(familyInstance01);
            familyInstances.Add(familyInstance02);
            familyInstances.Add(familyInstance03);
            familyInstances.Add(familyInstance04);
            familyInstances.Add(familyInstance05);

            _CreateDimensionsBasedGMs _CreateDimensionsBasedGMs = new _CreateDimensionsBasedGMs(doc);
            _CreateDimensionsBasedGMs.color = new Color(255, 0, 0);
            _CreateDimensionsBasedGMs.Execute(familyInstances, 60000, "a", "", "", "");
        }
    }
